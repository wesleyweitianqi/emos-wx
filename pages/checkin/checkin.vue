<template>
	<view>
		...
		<view class="notice-container">
			...
			<text class="desc">When taking photos to sign in, you must take a frontal photo of yourself, as side photos will make it impossible to identify. In addition, do not wear sunglasses or hats when taking photos to avoid affecting the accuracy of taking photos and signing in.</text>
		</view>
	</view>
</template>
